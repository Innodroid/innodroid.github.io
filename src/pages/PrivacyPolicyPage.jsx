function PrivacyPolicyPage({ appName }) {
    return (
        <div style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif", padding: '1em' }}>
            <strong>Privacy Policy</strong>
            <p>
                This privacy policy applies to the {appName} app (hereby referred to as "Application") for mobile
                devices that was created by Innodroid, LLC (hereby referred to as "Service Provider") as a Freemium
            ...
            <p>
                ...
                us with certain personally identifiable information. The information that the Service Provider request
            ...
            <p>
                ...
                the Application, please contact them at admin@innodroid.com and they will respond in a reasonable time.
            </p>
            <br />
            ...
            <div>
                ...
                <p>
                    ...
                    Service Provider (admin@innodroid.com) so that they will be able to take the necessary actions.
                </p>
            </div>
            <br />
            ...
            <br />
            <p>This privacy policy is effective as of 2025-06-01</p>
            <br />
            ...
            <p>
                ...
                practices, please contact the Service Provider via email at admin@innodroid.com.
            </p>
        </div>
    );
}
